...
Now let's get all possible paths to the datacubes. The resulting dataframe including the paths and also descriptions of e.g. metric and or scenario - take a look!
