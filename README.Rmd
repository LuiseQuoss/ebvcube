...
This process is still work in progress. Right now you'll have to insert all the metadata in the Geobon Portal and then use the resulting json file to start. Additionally to that json file the function needs the amount of entities you want to add.
...
Afterwards you can add your data to the NetCDF from GeoTiff files. You need to indicate which scenario and/or metric and/or entity the data belongs to.
